...
const ProfileInfo = () => {
    ...
    return (
        <>
            ...
            {isVisible && <div className="fixed top-4 right-4 flex items-center w-full max-w-xs p-4 text-white bg-blue-600 rounded-lg shadow" role="alert" aria-live="assertive" aria-atomic="true">
                <div className="flex-1 text-sm font-normal">
                    Hello, world! This is a toast message.
                </div>
                <button
                    onClick={() => setIsVisible(false)}
                    className="ml-4 inline-flex flex-shrink-0 justify-center items-center h-5 w-5 rounded-lg text-white hover:bg-blue-700 focus:outline-none text-16"
                    aria-label="Close"
                >
                    ×
                </button>
