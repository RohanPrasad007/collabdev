...
const PersonalizeYourMatrix = () => {
    ...
    const [logoPreview, setLogoPreview] = useState('/default-matrix-icon.svg'); // Replace with your default icon
    ...
    const handleCreateMatrix = async () => {
        ...
        try {
            ...
            const newMatrix = {
                ...
                logo: logoUrl || '/default-matrix-icon.svg', // Use default if no custom logo
                echoes: [],
                threads: [],
                track: null,
                users: [user.uid],
