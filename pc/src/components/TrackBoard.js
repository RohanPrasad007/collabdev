              ...
              return (
                ...
                >
                  {(provided, snapshot) => (
                    ...
                    >
                      <div
                        className={`bg-[#020222] rounded-lg p-4 ${
                          snapshot.isDragging ? "ring-2 ring-[#848DF9]" : ""
                        }`}
                      >
                        <div
                        ...
                        <Droppable droppableId={column.id} type="task">
                          {(provided, snapshot) => (
                            ...
                            >
                              ...
                              <div className="flex justify-end items-end">
                                <button
                                  className="w-10 h-10 rounded-full bg-[#848DF9] flex justify-center items-center cursor-pointer"
                                  onClick={() => props.setOpenAddTask(true)}
                                >
