...
// Since we're removing Next.js font, we'll use regular CSS
// You'd need to import Poppins font in your CSS or index.html
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (currentMatrixId) {
      navigate(`/matrix/${currentMatrixId}`)
    }
  }, [currentMatrixId, navigate])
      ...
      <div className='w-[615px] h-[400px] bg-[#020222] rounded-[16px] py-[30px] px-[18px] text-center'>
        <div className='flex flex-col justify-center items-center'>
          ...
          <div className='w-[440px] mt-[8px]'>
            <p className='font-poppins font-medium text-[16px] text-[#C2C2F0]'>
              Get started by creating a new Matrix or joining one you've been invited to.
            </p>
          </div>
          <button
            className='bg-[#848DF9] w-[200px] h-[48px] rounded-[12px] mt-[24px] font-semibold text-[16px] text-[#FFFFFF] font-poppins'
        ...
        <div className='relative flex justify-center items-center'>
          ...
          <div className='bg-[#020222] w-[40px] h-[31px] absolute top-[24px] font-poppins font-bold text-[18px] text-[#E2E2FE]'>
            OR
          </div>
        </div>
        <div className='mt-[29px]'>
          <p className='font-poppins font-medium text-[14px] text-[#E2E2FE]'>Join with a Matrix ID</p>
          <form onSubmit={handleJoinMatrix} className='flex gap-[10px] mx-[24px] items-center mt-[14px]'>
            ...
            <button
              type="submit"
              className='bg-[#E433F5] w-[120px] h-[48px] rounded-[12px] flex justify-center items-center text-[16px] font-semibold text-[#FFFFFF] cursor-pointer font-poppins'
            >
              Join
            </button>
          </form>
